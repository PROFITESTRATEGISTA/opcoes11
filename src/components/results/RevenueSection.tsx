...
export default function RevenueSection({ structures, rolls, exercises, selectedAsset = 'all' }: RevenueSectionProps) {
  ...
  const revenueItems = [
    ...
    {
      title: 'Exercícios',
      description: `${exercises.filter(e => e.status === 'EXECUTADO').length} exercícios executados`,
  ...
  return (
    <div className="bg-gray-800 border border-gray-700 rounded-xl p-4 sm:p-6">
      <div className="flex items-center mb-6">
        ...
        <div>
          <h3 className="text-base sm:text-lg font-semibold text-white">Receitas</h3>
          {selectedAsset !== 'all' && (
